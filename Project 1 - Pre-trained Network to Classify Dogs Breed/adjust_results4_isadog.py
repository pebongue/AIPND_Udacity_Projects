...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        #print("THIS IS PRINTING A NEW DOGE NAME FIRST LINE READ: {}".format(line))
        ...
        while line != "":
            ...
            line = line.rstrip()
            #print("THIS IS PRINTING A NEW DOGE NAME LINE READ: {}".format(line))
            ...
            if line not in dognames_dic:
                dognames_dic[line] = 1
                #print("THIS NEW DOG NAME WAS ADDED TO DICT: ", dognames_dic[line])
            else:
               print("** Warning: Duplicate dog's name exist in directory:", line) 
